...
public class MVMath {
	...
	public static Vector3 multiply (Matrix3 m, Vector3 v){
		...
		double y = m.getElement(1, 0) * v.getElement(0) + m.getElement(1, 1) * v.getElement(1) + m.getElement(1, 2) * v.getElement(2);
		double z = m.getElement(2, 0) * v.getElement(0) + m.getElement(2, 1) * v.getElement(1) + m.getElement(2, 2) * v.getElement(2);
	...
	public static Vector3 crossProduct (Vector3 v1, Vector3 v2){
		...
		double y = -1.0 * (v1.getElement(0) * v2.getElement(2) - v1.getElement(2) * v2.getElement(0));
